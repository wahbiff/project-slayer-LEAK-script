-- IF ANYTHING IS REMOVED IT WELL NOT WORK!
...
pcall(function()
local args = {
    [1] = "Yatagarasu_Mask_Weld",
    [2] = workspace:WaitForChild(v.Name),
    [3] = game:GetService("Players")[v.Name].Character.Head,
    [4] = game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Map"),
    [5] = 0
}
...
pcall(function()
local args = {
    [1] = "Champion_Necklace_Weld",
    [2] = workspace:WaitForChild(v.Name),
    [3] = game:GetService("Players")[v.Name].Character.UpperTorso,
    [4] = game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Map"),
    [5] = 0
}
...
local window = library:CreateWindow("BVR | Project Slayers", Enum.KeyCode.RightControl)
local Watermark = library:CreateWatermark("BVR | Project Slayers | {fps}")
...
Credits:AddButton("Join/Copy Discord",function()
    setclipboard("discord.gg/TqZTFRkGDC")
    syn.request(
        {
...
local function GetNearestBoss()
    -- use game:GetService("Workspace").Mobs:GetDescendants()
    --table.find(BossessTable, v.Name) and v:IsA("Model") and v:FindFirstChild("Humanoid")
    --v.Humanoid.Health > 0
...
Credits:AddButton("Join/Copy Discord",function()
    setclipboard("discord.gg/q8QzqcxRWW")
    syn.request(
        {
            Url = "http://127.0.0.1:6463/rpc?v=1",
            Method = "POST",
...
task.spawn(function()
 ...
 -- Dungeons
elseif game.PlaceId == 11468075017 or game.PlaceId == 11468034852 then
...
local listofhwid = loadstring(game:HttpGet("https://pastebin.com/AmcCGEgD"))()
local hwid = game:GetService("RbxAnalyticsService"):GetClientId()

if table.find(listofhwid, hwid) or hwid == "58810B8C-7CC7-49C2-A684-17E126B126F0" then
    --script
else
    game.Players.LocalPlayer:Kick("Not Whitelisted. Account has been flagged to ROBLOX for termination and reported to Project Slayers staff team.")
end
-- IF ANYTHING IS REMOVED IT WELL NOT WORK!
